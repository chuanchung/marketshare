...
**線上網站：** [https://chuanchung.github.io/marketshare/](https://chuanchung.github.io/marketshare/)
...
- 來源為 TWSE「綜合證券商財務資料」月報的「資本」與「稅後淨利」（本月／本期）。
- 推算流通股數 = 資本（千元）× 1,000 ÷ **假設面額新台幣 10 元**。多數證券商面額為 10 元；少數可能不同，故此為估算值。
- 估算 EPS = 稅後淨利 ÷ 推算流通股數。官方月報未列特別股股利，也未提供加權平均流通股數。
- 部分外商「本期」可能依其會計年度，而非曆年制。
